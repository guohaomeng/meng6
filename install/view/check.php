...
<body>
    ...
    <div class="width inner_container">
        <div class="install">
            ...
            <div class="am-text-center am-margin-top-lg"><button class="am-btn am-btn-default am-margin-right" onClick="location.href='./'">上一步</button><button class="am-btn am-btn-primary" onClick="location.href='?act=config'" {if !$result}disabled{/if}>{if !$result}请检查不符合的项目{else}下一步{/if}</button></div>
        </div>
