...
<body>
    ...
    <div class="width">
        <ol class="am-breadcrumb am-breadcrumb-slash">
            ...
            <li class="am-active"><a href="{THIS_LOCAL}">发布主题</a></li>
        </ol>
    </div>
	...
	<div class="width minheight">
        ...
        <div class="bbs">
            <div class="lefter box">
                <div class="nav">
                	<a href="{THIS_LOCAL}" class="hover">发布主题</a>
                </div>
                <div class="newpost">
                	 <!---->
                     <form class="am-form am-form-horizontal form-add" method="post">
                      <div class="am-form-group">
                        ...
                        <div class="am-u-sm-10">
                        	<select name="classid" data-rule="分类:required;int;" style="width:100%;">
                      ...
                      <div class="am-form-group">
                        ...
                        <div class="am-u-sm-10">
                        	<input type="text" name="title" maxlength="50" style="width:100%;" data-rule="标题:required;">
                        </div>
                      </div>
                      <div class="am-form-group">
