...
<body>
    ...
    <div class="width">
        <ol class="am-breadcrumb am-breadcrumb-slash">
            ...
            <li class="am-active"><a href="{THIS_LOCAL}">查看主题</a></li>
        </ol>
    </div>
            ...
            <div class="lefter">
                 <div class="showbbs box">
                 	<div class="title">
                        ...
                        <div class="face"><img src="{if strlen($uface)}{$uface}{else}{WEB_ROOT}upfile/noface.gif{/if}" alt="{$uname}"></div>
                    </div>
                    {if $view_lever==1}
                        ...
                        <div class="am-comment-main">
                            <header class="am-comment-hd">
                                <div class="am-comment-meta">
                                    <a class="am-comment-author">{$rs[uname]}</a>　<time>{formatTime($rs[createdate])}</time>
                                </div>
