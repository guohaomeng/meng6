...
<body>
    ...
    <div class="width">
        <ol class="am-breadcrumb am-breadcrumb-slash">
            ...
            <li class="am-active"><a href="{N('bbs')}">社区首页</a></li>
        </ol>
    </div>
    ...
    <div class="width minheight">
        ...
        <div class="bbs">
            <div class="lefter box">
                <div class="nav">
                    <a href="{N('bbs')}"{if $fid==0} class="hover"{/if}>全部主题</a>
                    {foreach $bbscate as $key=>$val}
                    <a href="{N('bbs','','fid='.$val['cateid'].'')}"{if $fid==$val['cateid']} class="hover"{/if} title="{$val['catename']}">{$val['catename']}</a>
                    {/foreach}
                    <a href="{N('bbsadd','','fid='.$fid.'')}" class="btn">发布主题</a>
                </div>
                <div class="list">
                    <ul>
            ...
            <div class="righter box">
                <div class="user">
                    ...
                    <div class="face"><img src="{$uface}" alt="{$uname}"></div>
                    <div class="count">
                        <a href="{U('home/bbs/mytopic','uid='.$userid.'')}"><span>{$total_1}</span><p>主题数</p></a>
                        <a href="{U('home/bbs/myreply','uid='.$userid.'')}"><span>{$total_2}</span><p>回复数</p></a>
                    </div>
                </div>
