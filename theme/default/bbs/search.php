...
<body>
    ...
    <div class="width">
        <ol class="am-breadcrumb am-breadcrumb-slash">
            ...
            <li class="am-active"><a href="{THIS_LOCAL}">主题搜索</a></li>
        </ol>
    </div>
	...
	<div class="width minheight">
        ...
        <div class="bbs">
            <div class="lefter box">
            	<div class="nav">
                	所有包含<a href="{THIS_LOCAL}" class="active">{$keyword}</a>的主题
                ...
                <div class="list">
                	<ul>
                    	...
                    	<li>
                            ...
                            <div class="info">
                            	<h5><a href="{N('bbsshow','','id='.$rs[bbs_id].'')}" target="_blank" title="{$rs[title]}">{str_replace($keyword,"<font color=red>$keyword</font>",$rs[title])}</a>{if $rs[ontop]==1}<em>置顶</em>{/if}{if $rs[isnice]==1}<em>精</em>{/if}</h5>
