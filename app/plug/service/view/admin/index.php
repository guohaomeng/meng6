...
<body>
    <div class="position">当前位置：插件管理 > <a href="{THIS_LOCAL}">客服管理</a></div>
    <div class="border">
        <!---->
        <div class="am-btn-group">
            <a href="{U('add')}" class="am-btn am-btn-secondary am-radius am-text-sm am-margin-right-sm"><span class="am-icon-plus am-margin-right-sm"></span>添加客服</a>
        </div>
        ...
        <table class="am-table am-table-hover am-margin-top">
            <thead>
                <tr>
                    ...
                    <th width="80">ID</th>
                    <th>客服名称</th>
                    <th width="300">QQ号码</th>
                    <th width="80">状态</th>
                    <th width="150">操作</th>
                </tr>
            </thead>
            <tbody>
            {sdcms:rs top="0" table="sd_plug_service" where="1=1" order="ordnum,id"}
            {rs:eof}
            <tr>
            ...
            <tr>
                ...
                <td>{$rs[id]}</td>
                <td>{$rs[title]}</td>
                <td><a href="http://wpa.qq.com/msgrd?v=3&uin={$rs[qq]}&menu=yes" target="_blank">{$rs[qq]}</a></td>
