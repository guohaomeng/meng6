...
<body>
    <div class="position">当前位置：插件管理 > <a href="{U('index')}">客服管理</a> > <a href="{THIS_LOCAL}">添加客服</a></div>
    <div class="border">
        <!---->
        <legend>添加客服</legend>
        <form class="am-form am-form-horizontal" method="post">
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <input type="text" name="t0" size="50" placeholder="请输入客服名称" data-rule="客服名称:required;">
                </div>
            </div>
            <div class="am-form-group">
                <label class="am-u-sm-2 am-form-label">QQ号码</label>
                <div class="am-u-sm-10">
                    <input type="text" name="t1" size="50" placeholder="请输入QQ号码" data-rule="QQ号码:required;qq;">
                </div>
            </div>
            <div class="am-form-group">
                <label class="am-u-sm-2 am-form-label">排序</label>
                <div class="am-u-sm-10">
                    <input type="text" name="t2" size="50" value="0">
