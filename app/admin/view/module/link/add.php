...
<body>
    ...
    <div class="position">当前位置：扩展管理 > <a href="{U('index')}">链接管理</a> > <a href="{THIS_LOCAL}">添加链接</a></div>
    <div class="border">
        <!---->
        <legend>添加链接</legend>
        <form class="am-form am-form-horizontal" method="post">
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <input type="text" name="t0" size="50" placeholder="请输入网站名称" data-rule="网站名称:required;">
                </div>
            </div>
            <div class="am-form-group{if C('link_logo')==0} dis{/if}">
                <label class="am-u-sm-2 am-form-label">网站Logo</label>
                <div class="am-u-sm-10">
                    <input type="text" name="t1" id="t1" size="50">
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <input type="text" name="t2" size="50" placeholder="请输入网址" data-rule="网址:required;">
                </div>
            </div>
