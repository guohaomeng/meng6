        ...
        <article class="am-comment am-margin-top">
            ...
            <div class="am-comment-main">
                <header class="am-comment-hd">
                    ...
                    <div class="am-comment-actions"><a href="{N('bbsshow','','id='.$rs[bbsid].'')}" target="_blank"><i class="am-icon-external-link-square"></i></a> <a href="{U('edit',"id=".$rs[replyid]."")}"><i class="am-icon-pencil"></i></a> <a href="javascript:;" class="del" data-id="{U('del','id='.$rs[replyid].'')}"><i class="am-icon-close"></i></a></div>
                </header>
