...
<body>
    <div class="position">当前位置：系统管理 > <a href="{THIS_LOCAL}">部门管理</a></div>
    <div class="border">
        <!---->
        <div class="am-btn-group">
            <a href="{U('add')}" class="am-btn am-btn-secondary am-radius am-text-sm"><span class="am-icon-plus am-margin-right-sm"></span>添加部门</a>
        </div>
        ...
        <table class="am-table am-table-hover am-margin-top">
            ...
            <tr>
                ...
                <td>{$rs[id]}</td>
                <td>{$rs[title]}</td>
                <td><a href="{U('page',"id=".$rs[id]."")}">页面权限</a>　<a href="{U('cate',"id=".$rs[id]."")}">栏目权限</a></td>
