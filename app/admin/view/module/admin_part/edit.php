...
<body>
    <div class="position">当前位置：系统管理 > <a href="{U('index')}">部门管理</a> > <a href="{THIS_LOCAL}">编辑部门</a></div>
    <div class="border">
        <!---->
        <legend>编辑部门</legend>
        <form class="am-form am-form-horizontal" method="post">
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <input type="text" name="t0" size="30" maxlength="20" value="{$title}" placeholder="请输入部门名称" data-rule="部门名称:required;">
                </div>
            </div>
            <div class="am-form-group">
