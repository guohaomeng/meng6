...
<body>
    <div class="position">当前位置：会员管理 > <a href="{U('index')}">会员管理</a> > <a href="{THIS_LOCAL}">添加会员</a></div>
    <div class="border">
        <!---->
        <legend>添加会员</legend>
        <form class="am-form am-form-horizontal" method="post">
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <input type="text" name="t0" size="50" placeholder="请输入用户名" data-rule="用户名:required;username;">
                </div>
            </div>
            <div class="am-form-group">
                <label class="am-u-sm-2 am-form-label">密码</label>
                <div class="am-u-sm-10">
                    <input type="text" name="t1" size="50" placeholder="请输入密码" data-rule="密码:required;password;">
                </div>
            </div>
            <div class="am-form-group">
                <label class="am-u-sm-2 am-form-label">邮箱</label>
                <div class="am-u-sm-10">
                    <input name="t2" type="text" size="50" placeholder="请输入邮箱" data-rule="邮箱:required;email;">
                </div>
            </div> 
            <div class="am-form-group">
