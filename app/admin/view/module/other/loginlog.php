...
<body>
    ...
    <div class="border">
        ...
        <div class="am-btn-group am-btn-group-sm am-btn-toolbar am-margin-left-xs">
            ...
            <a class="am-btn am-btn-{if $type==1}warning{else}default{/if} am-radius" href="{U('index','type=1')}">成功</a>
            <a class="am-btn am-btn-{if $type==2}warning{else}default{/if} am-radius" href="{U('index','type=2')}">失败</a>
        </div>
