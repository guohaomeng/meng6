...
<body>
    ...
    <div class="border">
        ...
        <div class="am-btn-group">
            <a href="javascript:;" class="am-btn am-btn-secondary am-radius am-text-sm clear"><span class="am-icon-trash am-margin-right-sm"></span>删除无效标签</a>
        </div>
        ...
        <table class="am-table am-table-hover am-margin-top">
            ...
            <tbody>
            {sdcms:rs pagesize="20" table="sd_tags" where="1=1" order="hits desc,id desc"}
            {rs:eof}
            <tr>
