...
<body>
    <div class="position">当前位置：<a href="{U('index')}">栏目管理</a>{$position} > <a href="{THIS_LOCAL}">移动栏目</a></div>
    <div class="border">
        <!---->
        <legend>移动栏目</legend>
        <form class="am-form am-form-horizontal" method="post">
            <div class="am-form-group">
                <label class="am-u-sm-2 am-form-label">当前栏目</label>
                <div class="am-u-sm-10">
                    <input type="text" size="50" value="{$catename}" readonly>
                </div>
            </div>
            <div class="am-form-group">
                <label class="am-u-sm-2 am-form-label">目标栏目</label>
                <div class="am-u-sm-10">
                    <select name="t0" size="10" class="w420" data-rule="目标栏目:required;">
