...
<body>
    ...
    <div class="border">
        ...
        <div class="am-btn-group">
            <a href="{U('add')}" class="am-btn am-btn-secondary am-radius am-text-sm"><span class="am-icon-plus am-margin-right-sm"></span>添加内链</a>
        </div>
        ...
        <table class="am-table am-table-hover am-margin-top">
            ...
            <tbody>
            {sdcms:rs top="0" table="sd_sitelink" where="1=1" order="ordnum,id"}
            {rs:eof}
            <tr>
