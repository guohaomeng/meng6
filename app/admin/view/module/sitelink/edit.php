...
<body>
    <div class="position">当前位置：扩展管理 > <a href="{U('index')}">内链管理</a> > <a href="{THIS_LOCAL}">编辑内链</a></div>
    <div class="border">
        <!---->
        <legend>编辑内链</legend>
        <form class="am-form am-form-horizontal" method="post">
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <input type="text" name="t1" size="50" value="{$url}" placeholder="请输入链接网址" data-rule="链接网址:required;">
                </div>
            </div>
            <div class="am-form-group">
                <label class="am-u-sm-2 am-form-label">替换次数</label>
                <div class="am-u-sm-10">
                    <input type="text" name="t2" size="50" maxlength="10" value="{$num}">
                    <span class="am-margin-left input-tips">为0时替换全部</span>
                </div>
            </div> 
            <div class="am-form-group">
