...
<body>
    <div class="position">当前位置：系统管理 > <a href="{U('index')}">菜单管理</a> > <a href="{THIS_LOCAL}">编辑菜单</a></div>
    <div class="border">
        <!---->
        <legend>编辑菜单</legend>
        <form class="am-form am-form-horizontal" method="post">
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <input type="text" name="t0" size="30" value="{$title}" placeholder="请输入菜单名称" data-rule="菜单名称:required;">
                </div>
            </div>
            {if $followid!=0}
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <input type="text" name="t1" size="30" value="{$cname}" placeholder="请输入控制器名称" data-rule="控制器名称:required;">
                </div>
            </div>
            <div class="am-form-group">
                <label class="am-u-sm-2 am-form-label">动作名称</label>
                <div class="am-u-sm-10">
                    <input type="text" name="t2" size="30" value="{$aname}" placeholder="请输入动作名称" data-rule="动作名称:required;">
                </div>
            </div>
            <div class="am-form-group">
                <label class="am-u-sm-2 am-form-label">附加参数</label>
                <div class="am-u-sm-10">
                    <input type="text" name="t3" size="30" value="{$dname}">
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <input type="text" name="t4" size="30" value="{$ordnum}">
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <label class="am-radio-inline">
                        <input type="radio" name="t5" id="t5_1" value="1"{if $islock==1} checked{/if}><span for="t5_1">显示</span>
                    </label>
                    <label class="am-radio-inline">
                        <input type="radio" name="t5" id="t5_2" value="0"{if $islock==0} checked{/if}><span for="t5_2">隐藏</span>
                    </label>
                </div>
            </div>
