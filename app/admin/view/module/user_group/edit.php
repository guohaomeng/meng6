...
<body>
    <div class="position">当前位置：会员管理 > <a href="{U('index')}">会员组管理</a> > <a href="{THIS_LOCAL}">编辑会员组</a></div>
    <div class="border">
        <!---->
        <legend>编辑会员组</legend>
        <form class="am-form am-form-horizontal" method="post">
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <input type="text" name="t0" size="50" value="{$gname}" placeholder="请输入会员组名称" data-rule="会员组名称:required;">
                </div>
            </div>
            <div class="am-form-group">
