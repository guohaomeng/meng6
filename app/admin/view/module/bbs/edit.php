        ...
        <form class="am-form am-form-horizontal" method="post">
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <select name="t6" data-rule="分类:required;int;" class="w420">
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <input type="text" name="t0" size="50" value="{$title}" data-rule="主题:required;">
                </div>
            </div>
            <div class="am-form-group">
            ...
            <div class="am-form-group">
                <label class="am-u-sm-2 am-form-label">人气</label>
                <div class="am-u-sm-10">
                    <input type="text" name="t2" size="50" value="{$hits}" data-rule="人气:required;int;">
                </div>
            </div>
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <label class="am-checkbox-inline">
                        <input type="checkbox" name="t3[]" id="t3" value="1"{if $isnice==1} checked{/if}><span for="t5">设置精华</span>
                    </label>
                    <label class="am-checkbox-inline">
                        <input type="checkbox" name="t4[]" id="t4" value="1"{if $ontop==1} checked{/if}><span for="t13">设置置顶</span>
                    </label>
                </div>
            </div>
            <div class="am-form-group">
