...
<body>
    ...
    <div class="border">
        ...
        <div class="am-btn-group">
            ...
            <div class="am-dropdown" data-am-dropdown>
                ...
                <ul class="am-dropdown-content">
                    ...
                    <li class="am-divider"></li>
                    <li><a href="javascript:;" class="btach" type="5">批量删除</a></li>
                    <li class="am-divider"></li>
                </ul>
            </div>
        </div>
        ...
        {if sdcms[url_mode]==1}<input type="hidden" name="m" value="{C('ADMIN')}" /><input type="hidden" name="c" value="book" /><input type="hidden" name="a" value="index" />{/if}
        ...
        <table class="am-table am-table-hover am-margin-top">
            ...
            <tr>
                ...
                <td>{iif(strlen($rs[reply])!=0,'已回复','<em>未回复</em>')}　{iif($rs[islock]==1,'已审','<em>未审</em>')}</td>
