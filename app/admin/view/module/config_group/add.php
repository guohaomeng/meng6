...
<body>
    <div class="position">当前位置：系统管理 > <a href="{U('index')}">设置分组</a> > <a href="{THIS_LOCAL}">添加分组</a></div>
    <div class="border">
        <!---->
        <legend>添加分组</legend>
        <form class="am-form am-form-horizontal" method="post">
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <input type="text" name="t0" size="30" placeholder="请输入分组名称" data-rule="分组名称:required;">
                </div>
            </div>
            <div class="am-form-group">
                <label class="am-u-sm-2 am-form-label">分组排序</label>
                <div class="am-u-sm-10">
                    <input type="text" name="t1" size="30" value="0">
