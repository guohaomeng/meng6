...
<body>
    ...
    <div class="position">当前位置：系统管理 > <a href="{U('form/index')}">表单管理</a> > <a href="{U('index',"fid=".$fid."")}">{$title}管理</a> > <a href="{THIS_LOCAL}">添加{$title}</a></div>
    <div class="border">
        <!---->
        <legend>添加{$title}</legend>
        <form class="am-form am-form-horizontal" method="post">
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <input type="text" name="ordnum" size="50" value="0">
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <label class="am-radio-inline">
                        <input type="radio" name="islock" id="islock_1" value="1" checked><span for="islock_1">已审</span>
                    </label>
                    <label class="am-radio-inline">
                        <input type="radio" name="islock" id="islock_2" value="0"><span for="islock_2">未审</span>
                    </label>
                </div>
            </div>
            <div class="am-form-group">
