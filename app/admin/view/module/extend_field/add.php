...
<body>
    <div class="position">当前位置：系统管理 > <a href="{U('extend/index')}">内容扩展</a> > <a href="{U('index',"eid=".$eid."")}">{$mtitle}</a> > <a href="{U('index',"eid=".$eid."")}">字段管理</a> > <a href="{THIS_LOCAL}">添加字段</a></div>
    <div class="border">
        <!---->
        <legend>添加字段</legend>
        <form class="am-form am-form-horizontal" method="post">
            ...
            <div class="am-form-group dis" id="listval">
                ...
                <div class="am-u-sm-10">
                    <textarea name="t3" rows="5" cols="50" data-rule="候选值:required;"></textarea>
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <input type="text" name="t4" size="50">
                </div>
            </div>
            <div class="am-form-group">
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <label class="am-radio-inline">
                        <input type="radio" name="t6" id="t6_1" value="1" checked><span for="t6_1">正常</span>
                    </label>
                    <label class="am-radio-inline">
