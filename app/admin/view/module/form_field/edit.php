...
<body>
    <div class="position">当前位置：系统管理 > <a href="{U('form/index')}">模型管理</a> > <a href="{U('index',"fid=".$fid."")}">{$ftitle}</a> > <a href="{U('index',"fid=".$form_id."")}">字段管理</a> > <a href="{THIS_LOCAL}">编辑字段</a></div>
    <div class="border">
        <!---->
        <legend>编辑字段</legend>
        <form class="am-form am-form-horizontal" method="post">
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <label class="am-radio-inline">
                        <input type="radio" name="t13" id="t13_1" value="1" {if $islist==1} checked{/if}><span for="t13_1">是</span>
                    </label>
                    <label class="am-radio-inline">
                        <input type="radio" name="t13" id="t13_2" value="0" {if $islist==0} checked{/if}><span for="t13_2">否</span>
                    </label>
                </div>
            </div>
            <div class="am-form-group">
