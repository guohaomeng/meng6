...
<body>
    <div class="position">当前位置：系统管理 > <a href="{U('form/index')}">表单管理</a> > <a href="{U('index',"fid=".$fid."")}">{$ftitle}</a> > <a href="{U('index',"fid=".$fid."")}">字段管理</a> > <a href="{THIS_LOCAL}">添加字段</a></div>
    <div class="border">
        <!---->
        <legend>添加字段</legend>
        <form class="am-form am-form-horizontal" method="post">
            ...
            <div class="am-form-group dis" id="field_select">
                ...
                <div class="am-u-sm-10">
                    <label class="am-radio-inline">
                        <input type="radio" name="t15" id="t15_1" value="1" ><span for="t15_1">是</span>
                    </label>
                    <label class="am-radio-inline">
                        <input type="radio" name="t15" id="t15_0" value="0" checked><span for="t15_0">否</span>
                    </label>
                </div>
            </div>
            ...
            <div class="am-form-group field_data dis">
                ...
                <div class="am-u-sm-10">
                    <input type="text" name="t16" size="50" data-rule="数据表:required;"><span class="am-margin-left input-tips">示范：sd_content</span>
                </div>
            </div>
            <div class="am-form-group field_data dis">
                <label class="am-u-sm-2 am-form-label">Join参数</label>
                <div class="am-u-sm-10">
                    <input type="text" name="t17" size="50"><span class="am-margin-left input-tips">可以为空，示范：left join sd_content on sd_model_news.cid=sd_content.id</span>
                </div>
            </div>
            <div class="am-form-group field_data dis">
                <label class="am-u-sm-2 am-form-label">Where参数</label>
                <div class="am-u-sm-10">
                    <input type="text" name="t18" size="50"><span class="am-margin-left input-tips">可以为空，示范：islock=1</span>
                </div>
            </div>
            <div class="am-form-group field_data dis">
                <label class="am-u-sm-2 am-form-label">Order参数</label>
                <div class="am-u-sm-10">
                    <input type="text" name="t19" size="50"><span class="am-margin-left input-tips">可以为空，示范：id desc</span>
                </div>
            </div>
            <div class="am-form-group field_data dis">
                <label class="am-u-sm-2 am-form-label">项目值</label>
                <div class="am-u-sm-10">
                    <input type="text" name="t20" size="50" data-rule="项目值:required;"><span class="am-margin-left input-tips">示范：id</span>
                </div>
            </div>
            <div class="am-form-group field_data dis">
                <label class="am-u-sm-2 am-form-label">项目标签</label>
                <div class="am-u-sm-10">
                    <input type="text" name="t21" size="50" data-rule="项目标签:required;"><span class="am-margin-left input-tips">示范：title</span>
                </div>
            </div>
            ...
            <div class="am-form-group">
                <label class="am-u-sm-2 am-form-label">列表显示</label>
                <div class="am-u-sm-10">
                    <label class="am-radio-inline">
                        <input type="radio" name="t14" id="t14_1" value="1"><span for="t14_1">是</span>
                    </label>
                    <label class="am-radio-inline">
                        <input type="radio" name="t14" id="t14_2" value="0" checked><span for="t14_2">否</span>
                    </label>
                </div>
            </div>
            <div class="am-form-group">
    ...
    $("#t2").change(function(){
        switch ($(this).val())
        {
            ...
            case "12":
                ...
                break;
			case "14":
                $("#upload_type,#listval,#field_radio,#editor_type,#maxlength,#field_select").css("display","none");
