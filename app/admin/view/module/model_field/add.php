...
<body>
    <div class="position">当前位置：系统管理 > <a href="{U('model/index')}">模型管理</a> > <a href="{U('index',"mid=".$mid."")}">{$mtitle}</a> > <a href="{U('index',"mid=".$mid."")}">字段管理</a> > <a href="{THIS_LOCAL}">添加字段</a></div>
    <div class="border">
        <!---->
        <legend>添加字段</legend>
        <form class="am-form am-form-horizontal" method="post">
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <select name="t14" class="w420" data-rule="表单分组:required;">
    ...
    $("#t2").change(function(){
        switch ($(this).val())
        {
            ...
            case "4":
                $("#upload_type,#listval,#field_radio,#editor_type,#field_select,.field_data").css("display","none");
                $("#maxlength").css("display","block");
                $("#t13").val("decimal(10,2) DEFAULT 0.00");
                break;
            case "5":
