...
<body>
    <div class="position">当前位置：系统管理 > <a href="{U('model/index')}">模型管理</a> > <a href="{THIS_LOCAL}">{$mtitle}</a> > 字段管理</div>
    <div class="border">
        <!---->
        <div class="am-btn-group">
            <a href="{U('add',"mid=".$mid."")}" class="am-btn am-btn-secondary am-radius am-text-sm"><span class="am-icon-plus am-margin-right-sm"></span>添加字段</a>
        </div>
