    ...
    <div class="border">
        ...
        <form class="am-form am-form-horizontal" method="post">
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <select name="t2" id="t2" class="w420" data-rule="字段名称:required;">
            ...
            <div class="am-form-group dis" id="list">
                ...
                <div class="am-u-sm-10">
                    <textarea name="t3" rows="5" cols="50"></textarea>
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <label class="am-radio-inline">
                        <input type="radio" name="t7" id="t7_1" value="1" checked><span for="t7_1">正常</span>
                    </label>
                    <label class="am-radio-inline">
                        <input type="radio" name="t7" id="t7_2" value="0"><span for="t7_2">锁定</span>
                    </label>
                </div>
            </div>
            <div class="am-form-group">
