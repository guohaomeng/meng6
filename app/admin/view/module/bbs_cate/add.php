        ...
        <form class="am-form am-form-horizontal" method="post">
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <input type="text" name="t0" size="50" placeholder="请输入分类名称" data-rule="分类名称:required;">
                </div>
            </div>
            <div class="am-form-group">
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <textarea name="t3" rows="3" cols="50"></textarea>
                </div>
            </div>
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    ...
                    <label class="am-radio-inline">
                    	<input type="checkbox" name="t6[]" id="t6_{$i}" value="{$rs[gid]}" checked><span for="t6_{$i}">{$rs[gname]}</span>
                    </label>
                    {/sdcms:rs}
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    {sdcms:rs top="0" table="sd_user_group" order="ordnum,gid"}
                    <label class="am-radio-inline">
                    	<input type="checkbox" name="t7[]" id="t7_{$i}" value="{$rs[gid]}" checked><span for="t7_{$i}">{$rs[gname]}</span>
                    </label>
                    {/sdcms:rs}
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    {sdcms:rs top="0" table="sd_user_group" order="ordnum,gid"}
                    <label class="am-radio-inline">
                    	<input type="checkbox" name="t8[]" id="t8_{$i}" value="{$rs[gid]}" checked><span for="t8_{$i}">{$rs[gname]}</span>
                    </label>
                    {/sdcms:rs}
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <label class="am-radio-inline">
                        <input type="radio" name="t5" id="t5_1" value="1" checked><span for="t5_1">启用</span>
                    </label>
                    <label class="am-radio-inline">
                        <input type="radio" name="t5" id="t5_2" value="0"><span for="t5_2">锁定</span>
                    </label>
                </div>
            </div>
            <div class="am-form-group">
