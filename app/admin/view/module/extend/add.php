...
<body>
    <div class="position">当前位置：系统管理 > <a href="{U('index')}">内容扩展</a> > <a href="{THIS_LOCAL}">添加方案</a></div>
    <div class="border">
        <!---->
        <legend>添加方案</legend>
        <form class="am-form am-form-horizontal" method="post">
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <input type="text" name="t0" size="50" placeholder="请输入方案名称" data-rule="方案名称:required;">
                </div>
            </div>
            <div class="am-form-group">
                <label class="am-u-sm-2 am-form-label">方案排序</label>
                <div class="am-u-sm-10">
                    <input type="text" name="t1" size="50" value="0">
