...
<body>
    <div class="position">当前位置：系统管理 > <a href="{THIS_LOCAL}">内容扩展</a></div>
    <div class="border">
        <!---->
        <div class="am-btn-group">
            <a href="{U('add')}" class="am-btn am-btn-secondary am-radius am-text-sm"><span class="am-icon-plus am-margin-right-sm"></span>添加方案</a>
        </div>
        ...
        <table class="am-table am-table-hover am-margin-top">
            ...
            <tr>
                ...
                <td><a href="{U('extendfield/index',"eid=".$rs[id]."")}"><span class="am-icon-navicon"></span> 字段管理</a>　<a href="{U('edit',"id=".$rs[id]."")}"><span class="am-icon-edit"></span> 编辑</a>　<a href="javascript:;" class="del" rel="{U('del','id='.$rs[id].'')}"><span class="am-icon-trash"></span> 删除</a></td>
            </tr>
            {/sdcms:rs}
            </tbody>
        </table>{if $total_rs>0}
