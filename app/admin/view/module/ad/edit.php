        ...
        <form class="am-form am-form-horizontal" method="post">
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <input type="text" name="t0" size="30" value="{$title}" placeholder="请输入广告名称" data-rule="广告名称:required;">
                </div>
            </div>
            <div class="am-form-group">
                    ...
                    <div class="imagelist">
                        <ul id="list_t1">
                            ...
                            <li num="{$num}">
                                ...
                                <div class="intro">
                                    <textarea name="t1[{$num}][desc]" placeholder="请输入描述...">{if isset($val['desc'])}{deal_strip($val['desc'])}{/if}</textarea>
                                </div>
                                <div class="intro">
                                    <textarea name="t1[{$num}][url]" placeholder="请输入链接网址...">{deal_strip($val['url'])}</textarea>
                                </div>
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <input type="text" name="t2" size="30" value="{$ordnum}">
