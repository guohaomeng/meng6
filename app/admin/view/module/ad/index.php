...
<body>
    ...
    <div class="border">
        ...
        <div class="am-btn-group">
            <a href="{U('add')}" class="am-btn am-btn-secondary am-radius am-text-sm"><span class="am-icon-plus am-margin-right-sm"></span>添加广告</a>
        </div>
        ...
        <table class="am-table am-table-hover am-margin-top">
            ...
            <tr>
                ...
                <td><a href="{U('edit',"id=".$rs[id]."")}"><span class="am-icon-edit"></span> 编辑</a>{if $rs[akey]==''}　<a href="javascript:;" class="del" rel="{U('del','id='.$rs[id].'')}"><span class="am-icon-trash"></span> 删除</a>{/if}</td>
            </tr>
            {/sdcms:rs}
            </tbody>
        </table>
