...
<body>
    <div class="position">当前位置：系统管理 > <a href="{U('index')}">管理员管理</a> > <a href="{THIS_LOCAL}">编辑管理员</a></div>
    <div class="border">
        <!---->
        <legend>编辑管理员</legend>
        <form class="am-form am-form-horizontal" method="post">
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <input type="text" name="t0" size="30" value="{$adminname}" disabled>
                </div>
            </div>
            <div class="am-form-group">
                <label class="am-u-sm-2 am-form-label">密码</label>
                <div class="am-u-sm-10">
                    <input type="text" name="t1" size="30" maxlength="16" ><span class="am-margin-left input-tips">不修改请留空</span>
                </div>
            </div>
            <div class="am-form-group">
                <label class="am-u-sm-2 am-form-label">笔名</label>
                <div class="am-u-sm-10">
                    <input type="text" name="t2" size="30" value="{$penname}" data-rule="笔名:required;">
                </div>
            </div>
            <div class="am-form-group">
