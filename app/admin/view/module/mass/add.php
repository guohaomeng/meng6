...
<body>
    <div class="position">当前位置：微信管理 > <a href="{U('index')}">群发管理</a> > <a href="{THIS_LOCAL}">新建群发</a></div>
    <div class="border">
        <!---->
        <legend>新建群发</legend>
        <form class="am-form am-form-horizontal" method="post">
            <div class="am-form-group">
                <label class="am-u-sm-2 am-form-label">消息类型</label>
                <div class="am-u-sm-10">
                    <select name="t1" id="t1" class="w420" data-rule="消息类型:required;">
            ...
            <div class="am-form-group">
                <div class="am-u-sm-10 am-u-sm-offset-2">
                    <button type="submit" class="am-btn am-btn-primary am-radius">执行</button>
