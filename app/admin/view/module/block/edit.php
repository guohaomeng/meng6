        ...
        <form class="am-form am-form-horizontal" method="post">
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <input type="text" name="t0" size="50" value="{$title}" placeholder="请输入区块说明" data-rule="区块说明:required;">
                </div>
            </div>
            <div class="am-form-group">
                <label class="am-u-sm-2 am-form-label">关键字</label>
                <div class="am-u-sm-10">
                    <input type="text" name="file" size="50" value="{$key}" readonly>
                    <input type="hidden" name="t1" size="50" value="{base64_encode($key)}">
                </div>
            </div>
            <div class="am-form-group">
