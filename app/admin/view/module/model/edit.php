...
<body>
    <div class="position">当前位置：系统管理 > <a href="{U('index')}">模型管理</a> > <a href="{THIS_LOCAL}">编辑模型</a></div>
    <div class="border">
        <!---->
        <legend>编辑模型</legend>
        <form class="am-form am-form-horizontal" method="post">
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <input type="text" name="t0" size="50" value="{$title}" placeholder="请输入模型名称" data-rule="模型名称:required;">
                </div>
            </div>
            <div class="am-form-group">
                <label class="am-u-sm-2 am-form-label">模型标识</label>
                <div class="am-u-sm-10">
                    <input type="text" name="t1" size="50" value="{$tablename}" disabled maxlength="20" data-rule="模型标识:required;">
                </div>
            </div>
            <div class="am-form-group">
                <label class="am-u-sm-2 am-form-label">模型描述</label>
                <div class="am-u-sm-10">
                    <input type="text" name="t2" size="50" value="{$model_desc}">
                </div>
            </div>
            <div class="am-form-group">
                <label class="am-u-sm-2 am-form-label">列表模板</label>
                <div class="am-u-sm-10">
                    <input type="text" name="t3" id="t3" size="50" value="{$list_skins}">　<input type="button" class="am-btn am-btn-secondary template" data-name="t3" data-url="{U('theme/template')}" value="选择">
                </div>
            </div>
            <div class="am-form-group">
                <label class="am-u-sm-2 am-form-label">内容模板</label>
                <div class="am-u-sm-10">
                    <input type="text" name="t4" id="t4" size="50" value="{$show_skins}">　<input type="button" class="am-btn am-btn-secondary template" data-name="t4" data-url="{U('theme/template')}" value="选择">
                </div>
            </div>
            <div class="am-form-group">
                <label class="am-u-sm-2 am-form-label">表单分组</label>
                <div class="am-u-sm-10">
                    <textarea name="t7" rows="5" cols="50">{$form_group}</textarea>
                    <span class="am-margin-left input-tips"><br>示范：项目名称1项目值1<br>　　　项目名称2|项目值2</span>
                </div>
            </div>
            <div class="am-form-group">
