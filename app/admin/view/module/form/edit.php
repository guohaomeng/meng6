...
<body>
    <div class="position">当前位置：系统管理 > <a href="{U('index')}">表单管理</a> > <a href="{THIS_LOCAL}">编辑表单</a></div>
    <div class="border">
        <!---->
            ...
            <div class="am-tabs-bd">
                ...
                <div class="am-tab-panel am-active">
                   ...
                   <div class="am-form-group">
                        ...
                        <div class="am-u-sm-10">
                            <input type="text" name="t0" size="50" value="{$title}" placeholder="请输入表单名称" data-rule="表单名称:required;">
                        </div>
                    </div>
                    <div class="am-form-group">
                        <label class="am-u-sm-2 am-form-label">表单标识</label>
                        <div class="am-u-sm-10">
                            <input type="text" name="t1" size="50" value="{$tablename}" disabled maxlength="20" data-rule="表单标识:required;">
                        </div>
                    </div>
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-10">
                            <label class="am-radio-inline">
                                <input type="radio" name="t2" id="t2_1" value="1"{if $iscode==1} checked{/if}><span for="t2_1">启用</span>
                            </label>
                            <label class="am-radio-inline">
                                <input type="radio" name="t2" id="t2_2" value="0"{if $iscode==0} checked{/if}><span for="t2_2">锁定</span>
                            </label>
                        </div>
                    </div>
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-10">
                            <label class="am-radio-inline">
                                <input type="radio" name="t11" id="t11_1" value="1"{if $backway==1} checked{/if}><span for="t11_1">列表页</span>
                            </label>
                            <label class="am-radio-inline">
                                <input type="radio" name="t11" id="t11_2" value="2"{if $backway==2} checked{/if}><span for="t11_2">当前页</span>
                            </label>
                        </div>
                    </div>
                    <div class="am-form-group">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-10">
                            <input type="text" name="t3" size="50" value="{$ordnum}">
                ...
                <div class="am-tab-panel">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-10">
                            <input type="text" name="t5" id="t5" size="50" value="{$add_skins}">　<input type="button" class="am-btn am-btn-secondary template" data-name="t5" data-url="{U('theme/template')}" value="选择">
                        </div>
                    </div>
                    <div class="am-form-group">
                        <label class="am-u-sm-2 am-form-label">列表模板</label>
                        <div class="am-u-sm-10">
                            <input type="text" name="t6" id="t6" size="50" value="{$list_skins}">　<input type="button" class="am-btn am-btn-secondary template" data-name="t6" data-url="{U('theme/template')}" value="选择">
                        </div>
                    </div>
                    <div class="am-form-group">
                        <label class="am-u-sm-2 am-form-label">内容模板</label>
                        <div class="am-u-sm-10">
                            <input type="text" name="t7" id="t7" size="50" value="{$show_skins}">　<input type="button" class="am-btn am-btn-secondary template" data-name="t7" data-url="{U('theme/template')}" value="选择">
                        </div>
                    </div>
                    <!--aaa-->
                </div>
                <div class="am-tab-panel">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-10">
                            <input type="text" name="t8" size="50" value="{$seotitle}">
                        </div>
                    </div>
                    <div class="am-form-group">
                        <label class="am-u-sm-2 am-form-label">关键字</label>
                        <div class="am-u-sm-10">
                            <input type="text" name="t9" size="50" value="{$seokey}">
                        </div>
                    </div>
                    <div class="am-form-group">
                        <label class="am-u-sm-2 am-form-label">描述</label>
                        <div class="am-u-sm-10">
                            <textarea name="t10" rows="5" cols="50">{$seodesc}</textarea>
                        </div>
                    </div>
                    <!--bbb-->
                </div>
