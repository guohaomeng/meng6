...
<body>
    <div class="position">当前位置：系统管理 > <a href="{U('index')}">邮件模板</a> > <a href="{THIS_LOCAL}">编辑模板</a></div>
    <div class="border">
        <!---->
        <legend>编辑模板</legend>
        <form class="am-form am-form-horizontal" method="post">
            <div class="am-form-group">
                ...
                <div class="am-u-sm-10">
                    <input type="text" name="t0" size="50" value="{$title}" placeholder="请输入用途" data-rule="用途:required;">
                </div>
            </div>
            <div class="am-form-group">
                <label class="am-u-sm-2 am-form-label">邮件标题</label>
                <div class="am-u-sm-10">
                    <input type="text" name="t1" size="50" value="{$mail_title}" placeholder="请输入邮件标题" data-rule="邮件标题:required;">
                </div>
            </div>
            <div class="am-form-group">
                <label class="am-u-sm-2 am-form-label">邮件内容</label>
                <div class="am-u-sm-10">
                    <script id="t2" name="t2" type="text/plain" style="height:260px;">{$mail_content}</script>
