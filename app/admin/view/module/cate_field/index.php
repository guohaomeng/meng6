...
<body>
    <div class="position">当前位置：系统管理 > <a href="{THIS_LOCAL}">栏目扩展</div>
    <div class="border">
        <!---->
        <div class="am-btn-group">
            <a href="{U('add')}" class="am-btn am-btn-secondary am-radius am-text-sm"><span class="am-icon-plus am-margin-right-sm"></span>添加字段</a>
        </div>
